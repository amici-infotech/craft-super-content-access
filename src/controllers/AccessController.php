<?php
/**
 * General Access management for channels (and future element scopes).
 *
 * Provides the settings area where administrators pick a default access policy
 * for a whole channel. These section-scoped policies apply to every entry in
 * the channel that has no element-level policy of its own.
 *
